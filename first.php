...
$query="select * from signupsp where signupsp.names = 1 ";
              ...
              <div class="border border-dark mt-3">
                <div class="row">
                  ...
                  <div class="col-xl-9 mt-3 mb-2">
                    <div class="row">
                      <p style="margin-left:100px; color:black;">NAME : <?php echo $rows['username']; ?></p>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <p style="margin-left:100px; color:black;">CONTACT : <?php echo $rows['contact']; ?></p>
                    </div>
                    <div class="row">
